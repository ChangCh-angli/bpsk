...
golden: tb/golden_bpsk
	./tb/golden_bpsk $(N_SAMPLES) $(AMP) $(SEED) $(FTW) scripts/rrc_phases_dec.txt tb/golden_out.hex
...
peak: tb/golden_bpsk
	./tb/golden_bpsk $(PEAK_N) $(AMP) $(SEED) $(FTW) scripts/rrc_phases_dec.txt /dev/null
